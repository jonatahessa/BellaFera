...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "bellafera01.mysql.uhserver.com"; // Caminho do servidor do BD
            String mydatabase = "bellafera01"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "bellafera01"; // Nome de usuario
