...
<link href="https://fonts.googleapis.com/css?family=Acme|Lobster|Permanent+Marker|Roboto|Lato" rel="stylesheet">
<script type="text/javascript" src="./_resources/domPaginaInicial.js"></script>
<script type="text/javascript" src="./_resources/consultaCep.js"></script>
